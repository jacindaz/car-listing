...
# Avoid hard-coding IDs in. Rather, use the manufacturer that you just created to set the ID:

toyota = Manufacturer.create!(name: "Toyota", country: "Japan")
Car.create!(manufacturer: toyota, color: "red", year: "2014", mileage: 100, description: "awesome red prius")
